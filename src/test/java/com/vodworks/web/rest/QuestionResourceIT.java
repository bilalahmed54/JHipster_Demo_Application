...
public class QuestionResourceIT {
    ...
    private static final String DEFAULT_JSON_BODY = "AAAAAAAAAA";
    private static final String UPDATED_JSON_BODY = "BBBBBBBBBB";
    ...
    public void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getJsonBody()).isEqualTo(DEFAULT_JSON_BODY);
    }
    ...
    @Test
    @Transactional
    public void checkJsonBodyIsRequired() throws Exception {
        int databaseSizeBeforeTest = questionRepository.findAll().size();
        // set the field null
        question.setJsonBody(null);
    ...
    public void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].jsonBody").value(hasItem(DEFAULT_JSON_BODY.toString())));
    }
    ...
    public void getQuestion() throws Exception {
        ...
        restQuestionMockMvc.perform(get("/api/questions/{id}", question.getId()))
            ...
            .andExpect(jsonPath("$.jsonBody").value(DEFAULT_JSON_BODY.toString()));
    }
    ...
    public void updateQuestion() throws Exception {
        ...
        Question testQuestion = questionList.get(questionList.size() - 1);
        assertThat(testQuestion.getJsonBody()).isEqualTo(UPDATED_JSON_BODY);
    }
