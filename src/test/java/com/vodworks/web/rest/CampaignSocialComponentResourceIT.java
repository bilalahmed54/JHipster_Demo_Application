...
public class CampaignSocialComponentResourceIT {
    ...
    private static final CampaignSocialComponentType DEFAULT_TYPE = CampaignSocialComponentType.CREATIVE;
    private static final CampaignSocialComponentType UPDATED_TYPE = CampaignSocialComponentType.INSTAGRAM;
    ...
    public void createCampaignSocialComponent() throws Exception {
        ...
        assertThat(testCampaignSocialComponent.isIsPrimary()).isEqualTo(DEFAULT_IS_PRIMARY);
        assertThat(testCampaignSocialComponent.getImageFileUrl()).isEqualTo(DEFAULT_IMAGE_FILE_URL);
        assertThat(testCampaignSocialComponent.getType()).isEqualTo(DEFAULT_TYPE);
    }
    ...
    public void checkIsPrimaryIsRequired() throws Exception {
        int databaseSizeBeforeTest = campaignSocialComponentRepository.findAll().size();
        // set the field null
        campaignSocialComponent.setIsPrimary(null);
    ...
    public void checkTypeIsRequired() throws Exception {
        int databaseSizeBeforeTest = campaignSocialComponentRepository.findAll().size();
        // set the field null
        campaignSocialComponent.setType(null);
    ...
    public void updateCampaignSocialComponent() throws Exception {
        ...
        assertThat(testCampaignSocialComponent.isIsPrimary()).isEqualTo(UPDATED_IS_PRIMARY);
        assertThat(testCampaignSocialComponent.getImageFileUrl()).isEqualTo(UPDATED_IMAGE_FILE_URL);
        assertThat(testCampaignSocialComponent.getType()).isEqualTo(UPDATED_TYPE);
    }
