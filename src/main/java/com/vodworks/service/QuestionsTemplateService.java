...
public class QuestionsTemplateService {
    ...
    @Value("${question.brands-heard-of}")
    ...
    @Value("${question.rate-purchase-again}")
    ...
    @Value("${question.rate-influencer}")
    ...
    @Value("${question.sub-grid-creative-emotion}")
