...
public class CampaignCompBrandResource {
     ...
     */
    @PostMapping("/save")
    public ResponseEntity<CampaignCompBrandDTO> createCampaignCompBrand(@Valid @RequestBody CampaignCompBrandDTO campaignCompBrandDTO) throws URISyntaxException, IOException {
